...
func NewEmailService(cfg *config.Config) (*EmailService, error) {
	// Validate SMTP config if not localhost (dev mode) / Valide la config SMTP si pas localhost
...
// validateSMTPConfig validates SMTP configuration / Valide la configuration SMTP

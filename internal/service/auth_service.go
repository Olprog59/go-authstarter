...
//
// Following ISP (Interface Segregation Principle), AuthService now depends
...
// For backward compatibility, it accepts UserRepository which implements
// all the segregated interfaces. In the future, this can be split into
// separate parameters for each interface.
func NewAuthService(
